...
`arduino/I2C通信テスト/` に、親機1台・子機5台・I2Cスキャナのテストコードを入れています。
...
```text
親機 5V  -> 子機1 5V -> 子機2 5V -> 子機3 5V -> 子機4 5V -> 子機5 5V
親機 GND -> 子機1 GND -> 子機2 GND -> 子機3 GND -> 子機4 GND -> 子機5 GND
親機 A4  -> 子機1 A4 -> 子機2 A4 -> 子機3 A4 -> 子機4 A4 -> 子機5 A4
親機 A5  -> 子機1 A5 -> 子機2 A5 -> 子機3 A5 -> 子機4 A5 -> 子機5 A5
```
